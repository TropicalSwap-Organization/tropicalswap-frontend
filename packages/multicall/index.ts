...
export function createMulticall<TProvider extends Provider>(
 ...
 /*  const multicall: MultiCall = async (abi: any[], calls: Call[], chainId = ChainId.MANTLE_TESTNET) => { */
 const multicall: MultiCall = async (abi: any[], calls: Call[], chainId = ChainId.MANTLE) => {
  ...
  /* const multicallv2: MultiCallV2 = async ({ abi, calls, chainId = ChainId.MANTLE_TESTNET, options, provider: _provider }) => { */
  const multicallv2: MultiCallV2 = async ({ abi, calls, chainId = ChainId.MANTLE, options, provider: _provider }) => {
  ...
  /* const multicallv3 = async ({ calls, chainId = ChainId.MANTLE_TESTNET, allowFailure, overrides }: MulticallV3Params) => { */
