...
function createMulticall(provider) {
  const multicall = (_0, _1, ..._2) => __async(this, [_0, _1, ..._2], function* (abi, calls, chainId = ChainId.MANTLE) {
  ...
  const multicallv2 = (_0) => __async(this, [_0], function* ({ abi, calls, chainId = ChainId.MANTLE, options, provider: _provider }) {
  ...
  const multicallv3 = (_0) => __async(this, [_0], function* ({ calls, chainId = ChainId.MANTLE, allowFailure, overrides }) {
    const multi = getMulticallContract(chainId, provider({ chainId }));
    if (!multi)
      throw new Error(`Multicall Provider missing for ${chainId}`);
