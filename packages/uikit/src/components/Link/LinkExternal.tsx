...
const LinkExternal: React.FC<React.PropsWithChildren<LinkProps>> = ({
  ...
  return (
    <Link external {...props}>
      ...
      {isBscScan && <BscScanIcon color="#C54177" ml="4px" />}
      {isAptosScan && <AptosIcon width="18" height="18" color="#C54177" ml="4px" />}
      {!isBscScan && !isAptosScan && <OpenNewIcon color="#C54177" ml="4px" />}
    </Link>
  );
};
