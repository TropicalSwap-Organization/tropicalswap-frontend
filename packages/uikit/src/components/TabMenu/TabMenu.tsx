    ...
    <Wrapper p={["0 4px", "0 16px"]} fullWidth={fullWidth}>
      <Inner fullWidth={fullWidth} gap={gap}>
        {Children.map(children, (child: ReactElement, index) => {
          ...
          const color = isActive ? "white" : "#794BCC";
          const inverseColor = isActive ? "#794BCC" : "white";
          const backgroundColor = isActive ? "#794BCC" : "white";
          const inverseBackgroundColor = isActive ? "white" : "#794BCC";
