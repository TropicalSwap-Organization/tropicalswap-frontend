...
const RoiCard: React.FC<React.PropsWithChildren<RoiCardProps>> = ({
  ...
  return (
    <RoiCardWrapper>
      <RoiCardInner>
        <Text fontSize="12px" color="secondary" bold textTransform="uppercase" style={{ color: "#400C8B" }}>
          ...
          {mode === CalculatorMode.PRINCIPAL_BASED_ON_ROI ? (
            ...
            <>
              <RoiDisplayContainer onClick={onEnterEditing}>
                ...
                <Text fontSize="24px" bold style={{ color: "#400C8B" }}>
                  $
                </Text>
              ...
              <IconButton scale="sm" variant="text" onClick={onEnterEditing}>
                <PencilIcon color="#C54177" />
              </IconButton>
            </>
          )}
        </Flex>
        <Text fontSize="12px" color="textSubtle" style={{ color: "#400C8B" }}>
          ...
          <Text
            ...
            maxWidth="100%"
            style={{ lineBreak: "anywhere", color: "#400C8B" }}
          >
