    ...
    <>
      {rewardCakePerSecond ? (
        <>
          ...
          <Text my="24px" style={{ color: "#400C8B" }}>
            {" "}
            {t("For example, if a 1x farm received 1 CAKE per second, a 40x farm would receive 40 CAKE per second.")}
          </Text>
          <Text style={{ color: "#400C8B" }}>{t("This amount is already included in all APR calculations for the farm.")}</Text>
        </>
      ) : (
        <>
          <Text style={{ color: "#400C8B" }}>
    ...
    <Footer p="16px" flexDirection="column">
      ...
      {isExpanded && (
        <Box px="8px">
          <Grid gridTemplateColumns="2.5fr 1fr" gridRowGap="8px" gridTemplateRows={`repeat(${gridRowCount}, auto)`}>
            {!isFarm && (
              <>
                ...
                <Text small textAlign="right" style={{ color: "#400C8B" }}>
            ...
            {isFarm && (
              <>
                ...
                <Flex justifyContent="flex-end" alignItems="flex-end">
                  <Text small textAlign="right" mr="4px" style={{ color: "#400C8B" }}>
                    {multiplier}
                  </Text>
          ...
          <BulletList>
            <li>
              <Text fontSize="12px" textAlign="center" color="textSubtle" display="inline" lineHeight={1.1} style={{ color: "#400C8B" }}>
            ...
            {isFarm && (
              <>
                <li>
                  <Text fontSize="12px" textAlign="center" color="textSubtle" display="inline" style={{ color: "#400C8B" }}>
            ...
            {performanceFee > 0 && (
              <li>
                <Text mt="14px" fontSize="12px" textAlign="center" color="textSubtle" display="inline" style={{ color: "#400C8B" }}>
          ...
          {linkHref && (
            <Flex justifyContent="center" mt="24px">
              <LinkExternal href={linkHref} style={{ color: "#400C8B" }}>{linkLabel}</LinkExternal>
            </Flex>
          )}
        </Box>
      )}
