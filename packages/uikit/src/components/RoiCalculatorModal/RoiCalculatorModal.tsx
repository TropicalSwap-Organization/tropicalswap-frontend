    ...
    >
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" mb="8px">
          <Text color="secondary" bold fontSize="12px" textTransform="uppercase" style={{ color: "#400C8B" }}>
          ...
          <Flex justifyContent="space-between" mt="8px">
            ...
            <Button
              ...
              width="128px"
              variant="tertiary"
              style={{ textTransform: "uppercase", color: "white", background: "#828282" }}
          ...
          {children || (
            <>
              <Text mt="24px" color="secondary" bold fontSize="12px" textTransform="uppercase" style={{ color: "#400C8B" }}>
                {t("Staked for")}
              </Text>
