...
const ModalInput: React.FC<React.PropsWithChildren<ModalInputProps>> = ({
  ...
  return (
    <div style={{ position: "relative" }}>
            ...
            [25, 50, 75].map((percent) => {
              ...
              return (
                <Button
                  ...
                  style={{ textTransform: "uppercase", color: "white", background: isAtCurrentPercent ? "#400C8B": "#828282", border: "none", boxShadow:"none" }}
                >
                  {percent}%
                </Button>
              );
          ...
          {maxAmount?.isGreaterThan(0) && (
            <>
              <Button
                ...
                style={{ textTransform: "uppercase", color: "white", background: isAtPercentMax ? "#400C8B": "#828282", border: "none" }}
              >
                {t("Max")}
              </Button>
            </>
      ...
      {isBalanceZero && (
        <StyledErrorMessage fontSize="14px" color="failure" style={{ color: "#C54177" }}>
      ...
      {needEnable && (
        <Text color="failure" fontSize="12px" mt="8px" style={{ color: "#C54177" }}>
