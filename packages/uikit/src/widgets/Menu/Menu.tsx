      ...
      >
        <Wrapper>
          <FixedContainer showMenu={showMenu} height={totalTopMenuHeight}>
            ...
            <StyledNav style={{ backgroundColor: "#5D5FEF" }}>
              <Flex>
          ...
          <BodyWrapper mt={!subLinks ? `${totalTopMenuHeight}px` : "0"}>
            {/* <Inner className="p-4 lg:p-12 flex justify-center bg-[#400C8B]">{children}</Inner> */}
            <Inner className="bg-[#400C8B]">{children}</Inner>
          </BodyWrapper>
        </Wrapper>
      </AtomBox>
      <Footer
