    ...
    <Modal title={t("Stake LP tokens")} onDismiss={onDismiss}>
      <ModalBody width={["100%", "100%", "100%", "420px"]}>
        ...
        <Flex mt="24px" alignItems="center" justifyContent="space-between">
          <Text mr="8px" color="textSubtle" style={{ color: "#400C8B" }}>
          ...
          {Number.isFinite(annualRoiAsNumber) ? (
            ...
            >
              <AnnualRoiDisplay style={{ color: "#C54177" }}>${formattedAnnualRoi}</AnnualRoiDisplay>
              <IconButton variant="text" scale="sm">
                <CalculateIcon color="textSubtle" width="18px" style={{ color: "#C54177" }} />
              </IconButton>
            </AnnualRoiContainer>
          ) : (
            <Skeleton width={60} />
        ...
        <ModalActions>
          <Button
            ...
            width="100%"
            disabled={pendingTx}
            style={{ border: "2px solid #400C8B", color: "#400C8B" }}
          >
            {t("Cancel")}
          </Button>
          {needEnable ? (
            <Button
              ...
              style={{ boxShadow: "none", background: "#FFBF00", color: "#400C8B" }}
            >
              {t("Enable")}
            </Button>
          ) : pendingTx ? (
        ...
        <LinkExternal href={addLiquidityUrl} style={{ alignSelf: "center", color: "#400C8B" }}>
