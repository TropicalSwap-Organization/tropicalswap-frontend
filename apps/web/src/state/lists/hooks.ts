    ...
    () =>
      _pickBy(
        ...
        (_, url) =>
          ...
          (chainId === ChainId.MANTLE && MANTLE_URLS.includes(url))
        /*   (chainId === ChainId.MANTLE_TESTNET && MANTLE_URLS.includes(url)) */
...
function combineMaps(
  ...
  return {
    ...
    [ChainId.MANTLE_TESTNET]: {
      ...map1[ChainId.MANTLE_TESTNET],
      ...map2[ChainId.MANTLE_TESTNET],
    },
    [ChainId.MANTLE]: {
      ...map1[ChainId.MANTLE],
      ...map2[ChainId.MANTLE],
