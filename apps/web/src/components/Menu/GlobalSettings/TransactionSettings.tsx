  ...
  return (
    <Flex flexDirection="column">
        ...
        <Flex flexWrap="wrap">
          <Button
            ...
            style={{
              color: "white",
              boxShadow: "none",
              background: userSlippageTolerance === 10 ? "#400C8B" : "#828282",
            }}
          ...
          <Button
            ...
            style={{
              color: "white",
              boxShadow: "none",
              background: userSlippageTolerance === 50 ? "#400C8B" : "#828282",
            }}
          ...
          <Button
            ...
            style={{
              color: "white",
              boxShadow: "none",
              background: userSlippageTolerance === 100 ? "#400C8B" : "#828282",
            }}
          ...
          <Flex alignItems="center">
            ...
            <Text style={{ color: "#400C8B" }} color="primary" bold ml="2px">
              %
            </Text>
          </Flex>
        </Flex>
      ...
      <Flex justifyContent="space-between" alignItems="center" mb="24px">
        <Flex alignItems="center">
          <Text style={{ color: "#400C8B" }}>{t("Tx deadline (mins)")}</Text>
          <QuestionHelper
            text={t(
