...
withCustomOnDismiss.displayName = "withCustomOnDismiss";
          ...
          <>
            <Flex pt="3px" flexDirection="column">
              ...
              <Flex
                ...
                mb="24px"
              >
                {/*       {chainId === ChainId.MANTLE_TESTNET && <GasSettings />} */}
            ...
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
              <Flex alignItems="center">
                <Text style={{ color: "#400C8B" }}>{t("Expert Mode")}</Text>
                <QuestionHelper
                  text={t(
