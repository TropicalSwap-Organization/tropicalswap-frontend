      ...
      <Flex flexWrap="wrap">
        <Button
          ...
          style={{
            ...
            boxShadow: "none",
            background:
              gasPrice === GAS_PRICE_GWEI.rpcDefault ? "#400C8B" : "#828282",
          }}
          variant={
            gasPrice === GAS_PRICE_GWEI.rpcDefault ? "primary" : "tertiary"
          }
        >
          {t("Default")}
        </Button>
        <Button
          ...
          style={{
            ...
            boxShadow: "none",
            background:
              gasPrice === GAS_PRICE_GWEI.default ? "#400C8B" : "#828282",
          }}
        ...
        <Button
          ...
          style={{
            ...
            boxShadow: "none",
            background:
              gasPrice === GAS_PRICE_GWEI.fast ? "#400C8B" : "#828282",
          }}
        ...
        <Button
          ...
          style={{
            ...
            boxShadow: "none",
            background:
              gasPrice === GAS_PRICE_GWEI.instant ? "#400C8B" : "#828282",
          }}
