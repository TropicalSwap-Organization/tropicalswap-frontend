    ...
    <AutoColumn gap="lg">
          ...
          >
            <Grid gridTemplateRows="1fr 1fr 1fr 1fr" gridGap="4px">
              ...
              <Flex alignItems="center">
                <Text mr="8px" style={{ color: "#400C8B" }}>
                  {token.name}
                </Text>
                <Text style={{ color: "#400C8B" }}>({token.symbol})</Text>
              </Flex>
              {token.chainId && (
                <>
                  <Text mr="4px" style={{ color: "#400C8B" }}>
                    {address}
                  </Text>
                  <Link
      ...
      <Grid gridTemplateRows="1fr 1fr" gridGap="4px">
        <Flex alignItems="center" onClick={() => setConfirmed(!confirmed)}>
          ...
          />
          <Text ml="8px" style={{ userSelect: "none", color: "#400C8B" }}>
            {hasRiskToken ? t("I acknowledge the risk") : t("I understand")}
          </Text>
          {hasRiskToken && (
            <div ref={targetRef}>
              <HelpIcon color="textSubtle" style={{ color: "#400C8B" }} />
