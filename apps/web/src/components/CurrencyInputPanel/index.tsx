...
const Container = styled.div<{ zapStyle?: ZapStyle; error?: boolean }>`
  ...
  box-shadow: ${({ theme, error }) =>
    theme.shadows[error ? "warning" : "inset"]};
  ${({ zapStyle }) =>
    !!zapStyle &&
    css`
...
export default function CurrencyInputPanel({
  ...
  return (
    <Box position="relative" id={id}>
      <Flex alignItems="center" justifyContent="space-between">
        ...
        {account && (
          <Text
            ...
            color="#400C8B"
            fontSize="14px"
            style={{ display: "inline", cursor: "pointer", color: "#400C8B" }}
          >
      ...
      <InputPanel style={{ background: "white" }}>
        <Container
          as="label"
          zapStyle={zapStyle}
          error={error}
          style={{ background: "#F7F7F7", border: "none", boxShadow: "none" }}
        >
          <LabelRow>
            <NumericalInput
              style={{ color: "#400C8B" }}
            ...
            <Flex justifyContent="flex-end" mr="1rem">
              <Flex maxWidth="200px">
                {Number.isFinite(amountInDollar) ? (
                  <Text fontSize="12px" color="#400C8B">
