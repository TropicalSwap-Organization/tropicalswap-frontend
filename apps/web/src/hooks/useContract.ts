...
export const useERC20 = (address: string, withSignerIfPossible = true) => {
  ...
  return useMemo(
    () => getBep20Contract(address, providerOrSigner),
...
export const useERC721 = (address: string, withSignerIfPossible = true) => {
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible);
  return useMemo(
    () => getErc721Contract(address, providerOrSigner),
    [address, providerOrSigner]
  );
};
...
export const useProfileContract = (withSignerIfPossible = true) => {
  ...
  return useMemo(
    () => getProfileContract(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useLotteryV2Contract = () => {
  const providerOrSigner = useProviderOrSigner(true, true);
  return useMemo(
    () => getLotteryV2Contract(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useMasterchef = (withSignerIfPossible = true) => {
  ...
  return useMemo(
    () => getMasterchefContract(providerOrSigner, chainId),
...
export const useFruitNinja = () => {
  const { chainId } = useActiveChainId();
  const { data: signer } = useSigner();
  return useMemo(() => getFruitNinjaContract(signer, chainId), [signer, chainId]);
};
...
export const useTradingCompetitionContractEaster = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getTradingCompetitionContractEaster(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useTradingCompetitionContractFanToken = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getTradingCompetitionContractFanToken(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useTradingCompetitionContractMobox = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getTradingCompetitionContractMobox(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useTradingCompetitionContractMoD = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getTradingCompetitionContractMoD(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useVaultPoolContract = (
  vaultKey: VaultKey
): CakeVaultV2 | CakeFlexibleSideVaultV2 => {
  const { data: signer } = useSigner();
  return useMemo(() => {
...
export const useCakeVaultContract = (withSignerIfPossible = true) => {
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible);
  return useMemo(
    () => getCakeVaultV2Contract(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useChainlinkOracleContract = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getChainlinkOracleContract(address, providerOrSigner),
...
export const useAnniversaryAchievementContract = (
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getAnniversaryAchievementContract(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const useFarmAuctionContract = (withSignerIfPossible = true) => {
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getFarmAuctionContract(providerOrSigner),
    [providerOrSigner]
  );
};
...
export const usePotterytVaultContract = (address) => {
  const { data: signer } = useSigner();
  return useMemo(
    () => getPotteryVaultContract(address, signer),
    [address, signer]
  );
};
...
export function useBCakeFarmBoosterContract(withSignerIfPossible = true) {
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getBCakeFarmBoosterContract(providerOrSigner),
    [providerOrSigner]
  );
}
...
export function useBCakeFarmBoosterProxyFactoryContract(
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible, true);
  return useMemo(
    () => getBCakeFarmBoosterProxyFactoryContract(providerOrSigner),
    [providerOrSigner]
  );
}

export function useBCakeProxyContract(
  ...
  return useMemo(
    () =>
      ...
      getBCakeProxyContract(proxyContractAddress, providerOrSigner),
...
export const useNonBscVault = (withSignerIfPossible = true) => {
  ...
  const providerOrSigner = useProviderOrSigner(withSignerIfPossible);
  return useMemo(
    () => getNonBscVaultContract(providerOrSigner, chainId),
    [providerOrSigner, chainId]
  );
};

export const useCrossFarmingProxy = (
  proxyContractAddress: string,
  withSignerIfPossible = true
) => {
  const { chainId } = useActiveChainId();
...
export const useStableSwapNativeHelperContract = () => {
  ...
  const { data: signer } = useSigner();
  return useMemo(
    () => getStableSwapNativeHelperContract(signer, chainId),
    [signer, chainId]
  );
};
...
export const useLaunchpad = () => {
  ...
  return useMemo(
    () => getLaunchpadContract(signer, chainId),
    [signer, chainId]
  );
};
