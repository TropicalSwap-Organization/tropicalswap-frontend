    ...
    <ModalContainer $minWidth="320px">
      <ModalBody p="24px" maxWidth="400px">
        <Flex justifyContent="center" mb="32px">
          <Image
            src="/images/predictions/chartwarning.svg"
            width={190}
            height={118}
          />
        </Flex>
        ...
        <Ul>
          <li>
            {t(
              "Prices on cards come from Chainlink’s verifiable price oracle."
            )}
          </li>
          <li>
            {t(
        ...
        <Text as="p" mb="16px" fontSize="14px" color="textSubtle">
          {t(
            "Only the price from Chainlink (shown on the cards) determines the round's result."
          )}
        </Text>
        {/*         <LinkExternal
