...
const TopTradersGrid: React.FC<
  React.PropsWithChildren<{ data?: LeaderboardDataItem[]; isExpanded: boolean }>
> = ({ data, isExpanded }) => {
  ...
  const teamImages = [
    <LeaderboardStorm key="storm" />,
    <LeaderboardFlippers key="flippers" />,
    <LeaderboardCakers key="cakers" />,
  ];
