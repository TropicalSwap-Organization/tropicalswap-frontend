...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label =
    currency === bscTokens.cake ? t("Max. CAKE entry") : t("Max. token entry");
  ...
  const unlimitedToolipContent = (
    <Box>
      ...
      <Text display="inline">
        {t(
          "Lock more CAKE for longer durations to increase the maximum number of CAKE you can commit to the sale."
        )}
      </Text>
    </Box>
  );
      ...
      <ModalBody maxWidth="360px">
        <Box p="2px">
          <Flex justifyContent="space-between" mb="16px">
            ...
            <Text>{`${formatNumber(
              getBalanceAmount(maximumTokenEntry, currency.decimals).toNumber(),
              3,
              3
