...
//   React.PropsWithChildren<{ isCompact: boolean; orderCategory: ORDER_CATEGORY }>
// > = memo(({ orderCategory, isCompact }) => {
...
//   React.PropsWithChildren<{ isCompact: boolean }>
// > = ({ isCompact }) => {
//   const { t } = useTranslation();
//   const [activeTab, setIndex] = useState<ORDER_CATEGORY>(ORDER_CATEGORY.Open);
//   const handleClick = useCallback(
//     (tabType: ORDER_CATEGORY) => setIndex(tabType),
//     []
//   );
...
// LimitOrderTable.displayName = "LimitOrderTable";
...
OrderTable.displayName = "OrderTable"; // Add this line
