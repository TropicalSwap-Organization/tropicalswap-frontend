...
export const DetailLimitOrderModal: React.FC<
  React.PropsWithChildren<DetailLimitOrderModalProps>
> = ({ onDismiss, order, formattedOrder }) => {
  ...
  const [
    { cancellationErrorMessage, attemptingTxn, txHash },
...
const LimitTradeInfoCard: React.FC<
  React.PropsWithChildren<LimitTradeInfoCardProps>
> = memo(
  ({
...
LimitTradeInfoCard.displayName = "LimitTradeInfoCard";
