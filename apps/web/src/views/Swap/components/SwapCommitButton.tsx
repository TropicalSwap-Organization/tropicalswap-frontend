...
import SettingsModal, {
  withCustomOnDismiss,
} from "components/Menu/GlobalSettings/SettingsModal";
...
export default function SwapCommitButton({
  ...
  // Modals
  const [indirectlyOpenConfirmModalState, setIndirectlyOpenConfirmModalState] =
    useState(false);
  ...
  const userHasSpecifiedInputOutput = Boolean(
    currencies[Field.INPUT] &&
      ...
      parsedIndepentFieldAmount?.greaterThan(BIG_INT_ZERO)
  );
  ...
  if (noRoute && userHasSpecifiedInputOutput) {
    return (
      ...
      >
        ...
        {singleHopOnly && (
          <Text color="textSubtle">{t("Try enabling multi-hop trades.")}</Text>
        )}
      </GreyCard>
    );
  }
