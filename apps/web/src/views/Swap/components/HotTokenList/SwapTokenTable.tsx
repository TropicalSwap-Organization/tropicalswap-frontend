...
import {
  ...
  PageButtons,
  TableWrapper,
} from "views/Info/components/InfoTables/shared";
...
const SortButton = styled(Button)`
  ...
  background: ${({ theme }) =>
    theme.isDark ? theme.colors.backgroundDisabled : theme.colors.input};
  path {
    fill: ${({ theme }) =>
      theme.isDark ? "rgba(255, 255, 255, 0.2)" : "#B4ACCF"};
  }
  &.is-asc {
    background: ${({ theme }) =>
      theme.isDark ? theme.colors.input : theme.colors.textSubtle};
    path:first-child {
        ...
        {(type === "priceChange" || type === "liquidity") && (
          ...
          >
            ...
            <SortButton
              scale="sm"
              variant="subtle"
              className={arrowClassName(SORT_FIELD.priceUSD)}
            >
              <SortArrowIcon />
            </SortButton>
          </StyledClickableColumnHeader>
        ...
        {type !== "liquidity" && (
          ...
          >
            ...
            <SortButton
              scale="sm"
              variant="subtle"
              className={arrowClassName(SORT_FIELD.priceUSDChange)}
            >
              <SortArrowIcon />
            </SortButton>
          </StyledClickableColumnHeader>
        ...
        {type === "liquidity" && (
          ...
          >
            ...
            <SortButton
              scale="sm"
              variant="subtle"
              className={arrowClassName(SORT_FIELD.liquidityUSD)}
            >
              <SortArrowIcon />
            </SortButton>
          </StyledClickableColumnHeader>
        ...
        {type === "volume" && (
          ...
          >
            ...
            <SortButton
              scale="sm"
              variant="subtle"
              className={arrowClassName(SORT_FIELD.volumeUSD)}
            >
              <SortArrowIcon />
            </SortButton>
          </StyledClickableColumnHeader>
