      ...
      <AutoColumn gap="md">
        {parsedAmounts[Field.CURRENCY_A] && (
          <RowBetween align="flex-end">
            <Text style={{ color: "#400C8B" }} fontSize="24px">
              {parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}
            </Text>
            <RowFixed gap="4px">
              <CurrencyLogo currency={currencyA} size="24px" />
              <Text style={{ color: "#400C8B" }} fontSize="24px" ml="10px">
                {currencyA?.symbol}
              </Text>
            </RowFixed>
          </RowBetween>
        ...
        <Text small textAlign="left" pt="12px" style={{ color: "#400C8B" }}>
          {t(
    ...
    return (
      <>
        ...
        {pair && (
          <>
            <RowBetween>
              <Text style={{ color: "#400C8B" }}>{t("Price")}</Text>
              <Text style={{ color: "#400C8B" }}>
                1 {currencyA?.symbol} ={" "}
