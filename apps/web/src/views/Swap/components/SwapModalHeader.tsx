    ...
    <AutoColumn gap="md">
      <RowBetween align="flex-end">
        <RowFixed gap="4px">
          ...
          />
          <TruncatedText fontSize="24px" style={{ color: "#400C8B" }}>
            {inputAmount.toSignificant(6)}
          </TruncatedText>
        </RowFixed>
        <RowFixed gap="0px">
          <Text fontSize="24px" ml="10px" style={{ color: "#400C8B" }}>
            {inputAmount.currency.symbol}
          </Text>
        </RowFixed>
      </RowBetween>
      <RowFixed>
        <ArrowDownIcon width="16px" ml="4px" color="#400C8B" />
      </RowFixed>
      <RowBetween align="flex-end">
        <RowFixed gap="4px">
      ...
      >
        <RowFixed style={{ width: "100%" }}>
          <Text style={{ color: "#400C8B" }} bold textTransform="uppercase">
            {t("Slippage Tolerance")}
          </Text>
          <Text style={{ color: "#794BCC" }} bold ml="auto" textAlign="end">
        ...
        <Text
          small
          textAlign="left"
          style={{ maxWidth: "320px", color: "#400C8B" }}
        >
          {tradeInfoText}
        </Text>
      </AutoColumn>
