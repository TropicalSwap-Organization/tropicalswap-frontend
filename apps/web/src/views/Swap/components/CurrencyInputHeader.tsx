...
const CurrencyInputHeader: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const titleContent = (
    <>
      <div className="relative w-full">
        ...
        <div className="text-[#400C8B]">Convert tokens with ease.</div>
        <img
          className="absolute w-40 h-40  top-0 right-32 z-10"
          src="/images/swap-header.png"
          alt="swap-header"
        />
      </div>
  ...
  return (
    <Swap.CurrencyInputHeader
      title={titleContent}
      subtitle={<></>}
      className="bg-[#A5A6F6] text-red border-none"
    />
  );
};
