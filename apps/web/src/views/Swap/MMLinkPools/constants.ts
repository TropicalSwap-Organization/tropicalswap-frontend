...
export const NATIVE_CURRENCY_ADDRESS = getAddress(
...
export const MM_STABLE_TOKENS_WHITE_LIST: Record<
  number,
...
export const MM_SIGNER = {
  ...
  [ChainId.MANTLE_TESTNET]: "0x945BCF562085De2D5875b9E2012ed5Fd5cfaB927",
};
