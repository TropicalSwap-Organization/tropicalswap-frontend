...
export const SmartSwapForm: React.FC<{
  ...
  // for expert mode
  const [isExpertMode, expertMode] = useExpertModeManager();
  ...
  return (
    <>
      ...
      <div className="lg:block hidden">
        <CurrencyInputHeader
          title={t("Swap")}
          subtitle={t("Trade tokens in a heartbeat.")}
          hasAmount={hasAmount}
      ...
      <Wrapper
        id="swap-page"
        style={{ minHeight: "412px", background: "white" }}
      >
        {/* test */}
        <div className="flex">
          <div className="w-[70%]">
        ...
        <AutoColumn gap="sm">
            ...
            <AutoColumn>
              {allowUseSmartRouter && (
                <Message variant="warning" mb="8px">
                  <MessageText>
                    {t("This route includes StableSwap and can’t edit output")}
                  </MessageText>
                </Message>
              )}
          ...
          {showWrap ? null : (
            <SwapUI.Info
              ...
              allowedSlippageSlot={
                isMMBetter || (!v2Trade && !isExpertMode) ? (
                  <MMSlippageTolerance />
                ) : undefined
              }
            />
        ...
        <Box mt="0.25rem" className="flex justify-center">
          {!tradeWithStableSwap &&
          !v2Trade &&
          ...
          shouldShowMMError(mmOrderBookTrade?.inputError) ? (
            ...
            <MMCommitButton
              ...
              swapInputError={
                mmOrderBookTrade?.inputError ||
                parseMMError(mmRFQTrade?.error?.message)
              }
