...
const nodeRealProvider = new JsonRpcProvider(
  "https://bsc-mainnet.nodereal.io/v1/5a516406afa140ffa546ee10af7c9b24",
  56
);
...
export const getVotingPower = async (
  ...
  if (
    ...
    const [pricePerShare, { shares, lockEndTime, userBoostedShare }] =
      await multicallv2({
        abi: cakeVaultAbiV2,
