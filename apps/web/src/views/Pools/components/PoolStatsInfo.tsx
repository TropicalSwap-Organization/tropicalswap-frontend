  ...
  return (
    <>
        ...
        (profileRequirement.required ||
          ...
          <Flex mb="8px" justifyContent="space-between">
            ...
            <Text small textAlign="right" style={{ color: "#400C8B" }}>
              ...
              {profileRequirement.thresholdPoints.gt(0) && (
                <Text small style={{ color: "#400C8B" }}>
                  {profileRequirement.thresholdPoints
                    .toNumber()
                    .toLocaleString()}{" "}
                  {t("Profile Points")}
                </Text>
            ...
            <Flex alignItems="center">
              <Link
                ...
                href={getBlockExploreLink(
                  hasPoolStarted ? endBlock : startBlock,
                  "countdown"
                )}
              >
                <Balance
      ...
      {/*      <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
        <LinkExternal style={{ color:"#400C8B" }} color="#400C8B" href={`/info/token/${earningToken.address}`} bold={false} small>
          {t('See Token Info')}
        </LinkExternal>
      </Flex>*/}
      {!vaultKey && (
