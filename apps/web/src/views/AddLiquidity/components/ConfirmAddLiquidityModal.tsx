...
> = ({
  ...
  if (
    (isStable && parsedAmounts[Field.CURRENCY_A]) ||
    ...
    percent =
      normalizedAmountCurrencyA / (normalizedAmountCurrencyA + amountCurrencyB);
  }
  ...
  const modalBottom = useCallback(() => {
    return (
      <Button width="100%" onClick={onAdd} mt="20px" style={{ boxShadow: 'none', background: "#FFBF00", color: "#400C8B" }}>
