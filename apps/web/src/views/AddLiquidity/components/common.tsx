...
export const PairDistribution = ({
  ...
  if (percent === 100) {
    stroke = currencyAValue ? "#FFBF00" : "secondary";
  }
      ...
      <Flex>
        ...
        <AutoColumn style={{ width: "100%" }}>
          {currencyA && (
            <RowBetween>
              <AutoRow gap="4px">
                <Dot bg="#FFBF00" style={{ color: "#400C8B" }} />
          ...
          {currencyB && (
            <RowBetween>
              <AutoRow gap="4px">
                <Dot bg="secondary" style={{ color: "#400C8B" }} />
  ...
  return (
    <AutoColumn gap="24px">
      <AutoColumn gap="8px">
        ...
        <GreyCard style={{ background: "white", border: "2px solid #400C8B" }}>
          <RowBetween>
            ...
            <Text color="#400C8B" ml="8px" style={{ color: "#400C8B" }}>
      ...
      {!noLiquidity && (
        <RowBetween>
          ...
          <TooltipText style={{ color: "#400C8B" }} ref={targetRef}>
            {allowedSlippage / 100}%
          </TooltipText>
