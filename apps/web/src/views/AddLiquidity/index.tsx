...
import { AppBodyLiquidity } from "components/App/AppBody";
        ...
        {showAddLiquidity && (
          <>
            ...
            <AppHeader
              ...
              subtitle={t("Receive LP tokens and earn 0.10% trading fees")}
              helper={t(
                "Liquidity providers earn a 0.10% trading fee on all trades made for that token pair, proportional to their share of the liquidity pair."
              )}
            ...
            <CardBody style={{ background: "white" }}>
              <AutoColumn gap="20px">
                {noLiquidity && (
                  <ColumnCenter>
                    <Message variant="warning">
                      <div>
                        <Text style={{ color: "#FFBF00" }} bold mb="8px">
                          {t("You are the first liquidity provider.")}
                        </Text>
                        <Text style={{ color: "#FFBF00" }} mb="8px">
                          {t(
                ...
                />
                <ColumnCenter>
                  <AddIcon width="16px" color="#5C379E" />
                </ColumnCenter>
                <CurrencyInputPanel
                  showUSDPrice
                  onInputBlur={canZap ? zapIn.onInputBlurOnce : undefined}
