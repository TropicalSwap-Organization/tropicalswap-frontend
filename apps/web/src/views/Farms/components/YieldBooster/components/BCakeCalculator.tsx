...
const BCakeCalculator: React.FC<
  React.PropsWithChildren<BCakeCalculatorProps>
> = ({
  targetInputBalance,
  earningTokenPrice,
  initialState,
  ...
  const { isLoading, lockedAmount, lockedStart, lockedEnd } =
  ...
  const bCakeMultiplier = useGetCalculatorMultiplier(
    userBalanceInFarm,
    lpTokenStakedAmount,
    userLockedAmount,
    duration
  ...
  const {
    ...
    t(
      "Boost multiplier calculation does not include profit from CAKE staking pool"
    ),
    {
      placement: "top-end",
      tooltipOffset: [20, 10],
          ...
          <BCakeBlock style={{ marginTop: 24 }}>
            ...
            <Flex justifyContent="space-between" mt="8px">
              <Button
                ...
                style={{ color: "white", background: "#828282" }}
              >
                $100
              </Button>
              <Button
              ...
              <Button
                ...
                onClick={() =>
                  setPrincipalFromUSDValue(
                    getBalanceNumber(
                      lockedAmount.times(earningTokenPrice)
                    ).toFixed(2)
                  )
                }
              >
              ...
              <span ref={myBalanceTargetRef}>
                <HelpIcon width="16px" height="16px" color="#C54177" />
              </span>
          ...
          <BCakeBlock style={{ marginTop: 16 }}>
            ...
            >
              ...
              <Box
                ...
                top="3px"
              >
                <HelpIcon color="#C54177" />
              </Box>
            </Text>
            <Text color="textSubtle" fontSize={12} style={{ color: "#400C8B" }}>
              {t(
