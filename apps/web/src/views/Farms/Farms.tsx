...
const Farms: React.FC<React.PropsWithChildren> = ({ children }) => {
      ...
      const farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map(
        (farm) => {
          ...
          if (!farm.lpTotalInQuoteToken || !farm.quoteTokenPriceBusd) {
            // console.log("no quote token price")
            return farm;
          }
          ...
          // console.log("lptotalinquote",farm.lpTotalInQuoteToken)
  ...
  return (
    <FarmsContext.Provider value={providerValue}>
      ...
      <div
        style={{ background: "white", borderRadius: "24px", width: "1200px" }}
      >
        <div className="relative w-full p-10 bg-[#FFBF00] rounded-t-[24px] lg:block hidden">
          <div className="w-40 h-16 rounded-full bg-[#400C8B] flex items-center justify-center text-[#FFBF00] text-4xl font-bold mb-4">
            Farms
          </div>
          ...
          <img
            className="absolute w-40 h-60  -top-12 right-32 z-10"
            src="/images/farms-header.png"
            alt="swap-header"
          />
          <img
            className="absolute w-36 h-36  -bottom-2 right-64 z-10"
            src="/images/farms-hearder1.png"
            alt="swap-header"
          />
        </div>
        <Page>
              ...
              <Flex mt="20px">
                ...
                <ToggleWrapper>
                  <Toggle
                    ...
                    scale="sm"
                  />
                  <Text color="#5C379E" style={{ color: "#5C379E" }}>
                    {" "}
                    {t("Staked only")}
                  </Text>
                </ToggleWrapper>
